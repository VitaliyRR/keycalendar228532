...
Получен ограниченный штатный Excel-экспорт и в режиме чтения собраны отдельные UI-снимки с ID бронирований и карточками объектов. Закрытый набор хранится вне репозитория; в Git нет исходных клиентских строк, паспортов, паролей, токенов, feed-ссылок или кодов доступа. Excel не содержит устойчивых ID, статусов, валюты и журнала денег; расхождения с UI и смысл финансовых строк требуют сверки. Текущее покрытие и условия дальнейшего переноса описаны в [спецификации миграции](data/migration-spec.md).
