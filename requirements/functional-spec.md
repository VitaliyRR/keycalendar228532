...
Окна заезда и выезда объекта задаются в его местном времени: начало и при наличии конец окна заезда, начало при наличии и конец окна выезда. Отсутствующая граница остается неизвестной; одиночное время старой записи не превращается в выдуманный интервал. Окно объекта не подменяет плановое или фактическое время отдельной брони и не изменяет подсчет ночей.
