      ...
      const rawCases=[
        ...
        {dataset:'active_booking_cards_ui' as const,name:'active-booking-cards.jsonl',
          sheet:'active-booking-cards-ui',body:JSON.stringify({page:1,index:1,href:'/synthetic',
            ...
            history:'Synthetic'})+'\n',rows:1,columns:9},
        {dataset:'booking_card_facts_ui' as const,name:'booking-card-facts-ui.jsonl',
          sheet:'booking-card-facts-ui',body:JSON.stringify({href:'/event_calendars/123',
            source_lot_id:'456',lot_in_current_inventory:false,status:'Synthetic status',
            begin:'01.10.2026',end:'03.10.2026',info:'Synthetic card info',
            history:'Synthetic card history'})+'\n',rows:1,columns:null},
