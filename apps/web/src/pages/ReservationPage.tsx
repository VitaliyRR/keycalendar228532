...
export function ReservationList({orgId, mode='all', canWrite=true}: {orgId:string;mode?:'all'|'arrivals';canWrite?:boolean}) {
  ...
  const visibleSource=sourceRecords.slice(Math.min(sourcePage,sourcePageCount-1)*100,Math.min(sourcePage,sourcePageCount-1)*100+100);
