...
export function MigrationPage({orgId,validationOnly=false}:{orgId:string;validationOnly?:boolean}) {
  ...
  return <><PageHeader eyebrow="Перенос" title={validationOnly?'Проверка переноса':'Импорт и экспорт'} description="Проверка исследует уже загруженный пакет и не переносит записи в рабочую базу."/>
